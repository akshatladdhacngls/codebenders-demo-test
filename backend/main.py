...
def init_test_data(db: Session):
    ...
    fares = [
        ...
        models.Fare(fare_type="Flexible", description="Flexible booking options")
    ]
    db.add_all(fares)
...
# Uncomment to initialize test data when server starts
...
if __name__ == '__main__':
    uvicorn.run('backend:fastapp', port=8080, host='0.0.0.0', reload=True)